...
- AndroidX Lifecycle 2.4.1, Room 2.4.2, Navigation 2.4.2, Material 1.5.0 (001-java-kotlin-migration)
- kotlinx-serialization 1.7.3 for JSON processing (replaces Jackson)
...
- Kotlin 2.0.21 / JVM target 1.8 + Hilt 2.51.1, Jetpack Compose (composeBom 2024.12.01), Coroutines 1.9.0 (012-accumulator-testability)
